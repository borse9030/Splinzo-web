      ...
      <div className="w-full max-w-md">
        ...
        >
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-sm text-gray-400 mt-1 font-medium">Smart Expense Sharing</p>
          </div>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                required
                className="rounded-xl h-12 border-gray-200 bg-gray-50 focus:border-amber-400 focus:ring-amber-400/20 font-medium"
              />
            </div>
